...
namespace libdebug
{
    public partial class PS4DBG
    {
		...
		public static string GetLocalIPAddress()
		{
			...
			{
				if ((ni.NetworkInterfaceType == NetworkInterfaceType.Ethernet || ni.NetworkInterfaceType == NetworkInterfaceType.Wireless80211) && ni.OperationalStatus == OperationalStatus.Up && !ni.Description.ToLower().Contains("vmware"))
				{
